...
URL Source: https://opencode.ai/docs/sdk

Markdown Content:
---
title: SDK
description: Type-safe JS client for opencode server.
image: https://social-cards.sst.dev/opencode-docs/U0RL.png?desc=Type-safe%20JS%20client%20for%20opencode%20server.
---
...
| json\_schema | Returns validated JSON matching the provided schema    |
...
| ---------- | -------------- | ---------------------------------------------------------- |
| type       | 'json\_schema' | Required. Specifies JSON schema mode                       |
...
| Method                  | Description                        | Response                                                                                          |
| ----------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------- |
| find.text({ query })    | Search for text in files           | Array of match objects with path, lines, line\_number, absolute\_offset, submatches               |
