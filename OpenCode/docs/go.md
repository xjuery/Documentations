...
URL Source: https://opencode.ai/docs/go
...
The [model id](config.md) in your OpenCode config uses the format `opencode-go/<model-id>`. For example, for Kimi K2.6, you would use `opencode-go/kimi-k2.6` in your config.
