...
image: https://social-cards.sst.dev/opencode-docs/SW50cm8%3D.png?desc=Get%20started%20with%20OpenCode.
---
...
For the best experience on Windows, we recommend using [Windows Subsystem for Linux (WSL)](docs/windows-wsl.md). It provides better performance and full compatibility with OpenCode’s features.
...
If you are new to using LLM providers, we recommend using [OpenCode Zen](docs/zen.md). It’s a curated list of models that have been tested and verified by the OpenCode team.
...
The conversations that you have with OpenCode can be [shared with your team](docs/share.md).
